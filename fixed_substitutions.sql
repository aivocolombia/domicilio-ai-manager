🔍 Generando script SQL corregido para sustituciones...
...
2. Ejecuta las secciones 1-3 del script
3. Ejecuta la sección 4 para ver productos existentes
4. Anota los IDs reales que obtengas
5. Modifica la sección 5 con esos IDs
6. Ejecuta todo lo demás
