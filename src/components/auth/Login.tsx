      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-4">
          <div className="mx-auto w-24 h-24 bg-primary rounded-2xl flex items-center justify-center shadow-lg">
            <span className="text-2xl font-bold text-primary-foreground">A&F</span>
          </div>
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-foreground">Ajiaco & Frijoles</h1>
            <p className="text-muted-foreground">Sistema de Gestión de Pedidos</p>
          </div>
        </div>
