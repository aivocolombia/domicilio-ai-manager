-- =====================================================
-- SCRIPT REPARADO PARA SUSTITUCIONES (SIN IF NOT EXISTS)
-- =====================================================
...
-- PASO 3: CONSTRAINT ÚNICO (ejecutar solo si no existe)
-- Si da error "ya existe", simplemente continúa con el siguiente paso
...
-- Si dan error "ya existe", simplemente continúa
